...
local terminal = require("plugins.kilo-integration.terminal")
local file_sender = require("plugins.kilo-integration.send_file")
...
-- Apply keymaps
require("plugins.kilo-integration.keymaps")(state, terminal, file_sender)
